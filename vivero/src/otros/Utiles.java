...
public class Utiles {
	 ...
	 * 
	 * @param pregunta Pregunta que se muestra por pantalla para pedir el dato
	 ...
	 * 
	 * @param pregunta Pregunta que se muestra por pantalla para pedir el dato
	 * @param max Máximo número de caracteres que puede introducir el usuario
	 * @return Cadena introducida por el usuario
	 */
	 ...
	 * 
	 * @param pregunta Pregunta que se muestra por pantalla para pedir el dato
	 * @return Integer introducido por el usuario
	 */
	...
	/**
	 * Comprueba si la opcion del menu es incorrecta. 
	 * 
	 * @param opcion Opción introducida por el usuario
	 * @param min Valor mínimo que puede valer la opción introducida por el usuario
	 * @param max Valor máximo que puede valer la opción introducida por el usuario
	 * 
	 * @return Devuelve true si es incorrecta, false si es correcta
	 */
