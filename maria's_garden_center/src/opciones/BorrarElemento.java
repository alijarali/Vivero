...
/**
 * Esta clase borra elementos de la lista. Primero nos enseñará un listado con
...
public class BorrarElemento {
	...
	public static void borrarElemento() {
		...
		if(l==0) {
	 System.out.println("Lista vacía.Puedes añadir productos mediante la opción 'añadir elemento' o cargar el catálogo con la opción 'cargar lista' ");
	 }else {
